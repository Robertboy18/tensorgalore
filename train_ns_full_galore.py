...
#from neuralop.data.datasets.navier_stokes import load_navier_stokes_pt, NavierStokesDataset
from neuralop.training import setup#, Trainer
from neuralop.utils import get_wandb_api_key, count_model_params

from tensor_galore import AdamW, ProfilerTrainer
from tensor_galore.training_utils import get_scheduler, CheckpointTrainer
from tensor_galore.navier_stokes import FullSizeNavierStokes
...
ns_dataset = FullSizeNavierStokes(root_dir=config.data.root,
                                  n_train=config.data.n_train,
                                  n_test=config.data.n_tests[0],
                                  res=config.data.train_resolution)
